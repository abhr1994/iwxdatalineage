            ...
            if(row):
                ...
                if(validation_status):
                    ...
                    if(not schema_exists):
                        ...
                        print("Schema {schema_name} already exists..Skipping the Schema Creation".format(schema_name=row[0]))
                        logging.info("Schema {schema_name} already exists..Skipping the Schema Creation".format(schema_name=row[0]))
                else:
