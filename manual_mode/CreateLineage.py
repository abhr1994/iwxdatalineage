...
class CreateLineage:
    ...
    @staticmethod
    def define_lineage_link(tsconn, lineage_name, src_ds_conn, src_schema_name, tgt_ds_conn, tgt_schema_name, col_mappings):
        try:
...
def main():
    ...
    parser.add_argument('--lineage_file_path', required=False, default="./csv_sample_files/create_lineage.csv", help='Provide the location of lineage file path')
    ...
    with open(args["lineage_file_path"], 'r') as data:
        for line in csv.DictReader(data):
            ...
            try:
                CreateLineage.define_lineage_link(tsconn,lineage_name, src_ds_conn, src_schema, tgt_ds_conn, tgt_schema, col_mappings)
            except:
                pass
